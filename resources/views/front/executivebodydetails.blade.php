...
@section('og_image'){{asset('assets/img/executivebody/')}}/{{$member->image}}@endsection
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="lecturers-contact-info">
                            <img src="@if($member->image == null){{asset('assets/img/no-image.png')}}@else{{asset('assets/img/executivebody/')}}/{{$member->image}}@endif" class="img-responsive" alt="team">
                            <h2>{{$member->name}}</h2>
...
$("#preloader").show();
       ...
       $.ajax({
        url: "{{ route('executivebody.contact', $member->id) }}",
        type: "post",
