@extends('front.app')
@section('title')Office Stuffs - {{$front->title}}@endsection
@section('og_title')Office Stuffs - {{$front->title}}@endsection
@section('description'){{$front->title}} - Office Stuffs @endsection
@section('og_description'){{$front->title}} - Office Stuffs @endsection
@section('keyword')Office Stuffs, {{$front->keywords}}@endsection
