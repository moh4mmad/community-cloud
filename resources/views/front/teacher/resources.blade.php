...
<div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                        <ul class="profile-title">
                            <li class="active"><a href="{{ route('teacher.resources') }}" >Resources</a></li>
		...
		@endif
									<form method="post" action="{{ route('teacher.resources.search') }}">
										{{ csrf_field() }}
                                            ...
                                            <table class="table table-bordered table-responsive">
												...
												@endphp
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('teacher.resources.download', $resource->secret) }}" title="download" style="color: #8a0000;" class="btn-view">{{$resource->filename}}</a>
                                                        </td>
                                                    </tr>
													@endforeach
                                                </tbody>
