<?php $__env->startSection('title'); ?> Acad login | <?php echo e($system->app_title); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="form-items">
                        <h3>Acad Login</h3>
						<hr>
                        <form method="post" action="<?php echo e(route('acad.login')); ?>">
                        ...
                        <?php endif; ?>
                            ...
                            <div class="form-button">
								...
								<a href="<?php echo e(route('acad.forget.pass')); ?>">Forget password?</a>
                            </div>
                        </form>
						<hr>
