        ...
        <div class="container-fluid">
			...
			<div class="row">
                <div class="col-sm-12 text-center">
                    <div class="page-title-box">
                        <h4 class="page-title">Students data</h4> <hr/> <a href="<?php echo e(route('admin.student.add')); ?>" role="button" class="btn btn-info waves-effect waves-light">Add new student data</a></div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl">
					...
					<form role="search" method="post" action="<?php echo e(route('admin.students.search')); ?>">
						   ...
						   <div class="table-responsive">
                                <table class="table table-hover mb-0">
									...
									<tr>
											...
											<td>
											<a style="border-radius: 2px; font-size: 12px;" type="button" href="<?php echo e(route('admin.students.view', $student->student_id)); ?>" class="btn btn-primary waves-effect waves-light btn-sm">View</a>
											<a style="border-radius: 2px; font-size: 12px;" type="button" href="<?php echo e(route('admin.students.result', $student->student_id)); ?>" class="btn btn-primary waves-effect waves-light btn-sm">Result</a>
											<a style="border-radius: 2px; font-size: 12px;" type="button" href="<?php echo e(route('admin.students.deposid', $student->student_id)); ?>" class="btn btn-primary waves-effect waves-light btn-sm">Deposits</a>
											<a style="border-radius: 2px; font-size: 12px;" type="button" href="<?php echo e(route('admin.students.billing', $student->student_id)); ?>" class="btn btn-primary waves-effect waves-light btn-sm">Billing</a>
											<a style="border-radius: 2px; font-size: 12px;" type="button" href="<?php echo e(route('admin.students.completedcourses', $student->student_id)); ?>" class="btn btn-primary waves-effect waves-light btn-sm">Courses</a>
	...
	<div class="modal fade" id="guardian<?php echo e($student->student_id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelgrad" aria-hidden="true">
                               <div class="modal-dialog" role="document">
                                    <div class="modal-content">
										...
										<form method="post" enctype="multipart/form-data" action="<?php echo e(route('admin.students.guardian.update')); ?>">
										<?php echo e(csrf_field()); ?>
    ...
    buttons: {
        formSubmit: {
            ...
            action: function () {
                ...
                var form = $('<form action="<?php echo e(route("admin.students.password")); ?>" method="post">' +
    ...
    buttons: {
        tryAgain: {
            ...
            action: function(){
				...
				var form = $('<form action="<?php echo e(route("admin.students.deactivate")); ?>" method="post">' +
				             '<input type="hidden" name="student_id" value="' + this.$target.attr("student_id") + '" />' +
							 '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
							 '</form>');
				$('body').append(form);
    ...
    buttons: {
        tryAgain: {
            ...
            action: function(){
				...
				var form = $('<form action="<?php echo e(route("admin.students.activate")); ?>" method="post">' +
				             '<input type="hidden" name="student_id" value="' + this.$target.attr("student_id") + '" />' +
							 '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
							 '</form>');
				$('body').append(form);
