    ...
    buttons: {
        tryAgain: {
            ...
            action: function(){
				...
				var form = $('<form action="<?php echo e(route("admin.students.billing.remove")); ?>" method="post">' +
    ...
    buttons: {
        tryAgain: {
            ...
            action: function(){
				...
				var form = $('<form action="<?php echo e(route("admin.students.waiver.remove")); ?>" method="post">' +
