                        ...
                        <li class="list-inline-item dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown">
                                ...
                                <div class="dropdown-item noti-title">
									...
									<a class="dropdown-item" href="<?php echo e(route('acad.profile')); ?>"><i class="mdi mdi-account-circle m-r-5 text-muted"></i> Profile</a>
                                <div class="dropdown-divider"></div>
								<a class="dropdown-item" href="<?php echo e(route('acad.logout')); ?>">
            ...
            <div class="container-fluid">
                <div id="navigation">
                    ...
                    <ul class="navigation-menu text-center">
                        <li class="has-submenu"><a href="<?php echo e(route('acad.dashboard')); ?>"><i class="mdi mdi-airplay"></i>Dashboard</a></li>
						...
						?>
                                <li><a href="<?php echo e(route('acad.students')); ?>">Students</a></li>
                                <li><a href="<?php echo e(route('acad.students.verify')); ?>">Student verification <?php if($pending_students): ?><strong class="text-light bg-dark">New <?php echo e($pending_students); ?></strong> <?php endif; ?></a></li>
                            </ul>
						</li>
						<li class="has-submenu"><a href="<?php echo e(route('acad.idcard')); ?>"><i class="fas fa-id-card"></i>Id card generate</a></li>
                       
					   <li class="has-submenu"><a href="<?php echo e(route('acad.notice')); ?>"><i class="fas fa-bell"></i>Notice</a></li>
                       
					   <li class="has-submenu"><a href="<?php echo e(route('acad.profile')); ?>"><i class="fas fa-user"></i>Profile</a></li>
                       
						<li class="has-submenu"><a href="<?php echo e(route('acad.logout')); ?>"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
