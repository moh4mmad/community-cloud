        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl">
					...
					<form role="search" method="post" action="<?php echo e(route('admin.students.verify.search')); ?>">
						   ...
						   <div class="table-responsive">
                                <table class="table table-hover mb-0">
									...
									<tr>
											...
											<td>
											<a style="" type="button" href="<?php echo e(route('admin.students.view', $student->student_id)); ?>" class="btn btn-primary waves-effect waves-light btn-sm">View</a>
    ...
    buttons: {
        tryAgain: {
            ...
            action: function(){
				...
				var form = $('<form action="<?php echo e(route("admin.students.approve")); ?>" method="post">' +
    ...
    buttons: {
        tryAgain: {
            ...
            action: function(){
				...
				var form = $('<form action="<?php echo e(route("admin.students.remove")); ?>" method="post">' +
				             '<input type="hidden" name="student_id" value="' + this.$target.attr("student_id") + '" />' +
							 '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />' +
							 '</form>');
				$('body').append(form);
