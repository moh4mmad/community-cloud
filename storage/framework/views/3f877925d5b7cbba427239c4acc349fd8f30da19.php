...
<div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                        <ul class="profile-title">
                            <li class="active"><a href="<?php echo e(route('resources')); ?>" >Resources</a></li>
		...
		<?php endif; ?>
									<form method="post" action="<?php echo e(route('resources.search')); ?>">
                                            ...
                                            <table class="table table-bordered table-responsive">
												...
												?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo e(route('resources.download', $resource->secret)); ?>" title="download" style="color: #8a0000;" class="btn-view"><?php echo e($resource->filename); ?></a>
                                                        </td>
                                                    </tr>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
