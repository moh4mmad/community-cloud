            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 counter1-box wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".20s">
                        <h2 class="about-counter title-bar-counter" data-num="<?php echo e($front->faculty_members); ?>"><?php echo e($front->faculty_members); ?></h2>
                        <p>Faculty members</p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 counter1-box wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".40s">
                        <h2 class="about-counter title-bar-counter" data-num="<?php echo e($front->publications); ?>"><?php echo e($front->publications); ?></h2>
                        <p>Publications</p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 counter1-box wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".60s">
                        <h2 class="about-counter title-bar-counter" data-num="<?php echo e($front->achievements); ?>"><?php echo e($front->achievements); ?></h2>
                        <p>Achievements</p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 counter1-box wow fadeInUp" data-wow-duration=".5s" data-wow-delay=".80s">
                        <h2 class="about-counter title-bar-counter" data-num="<?php echo e($front->club_members); ?>"><?php echo e($front->club_members); ?></h2>
                        <p>Club Members</p>
                    </div>
                </div>
            </div>
