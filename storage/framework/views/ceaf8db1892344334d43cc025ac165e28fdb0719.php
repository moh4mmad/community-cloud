<?php $__env->startSection('title'); ?> Executive Body <?php $__env->stopSection(); ?>
...
<div class="widget stacked">
				...
				<section id="buttons">
				<button type="button" class="btn btn-default" data-toggle="modal" data-target="#add" >Add Executive Body</button>
				<br>
				</br>
				</section>				
				...
				<div class="widget-content">
					...
					<table id="datatable" class="table table-bordered table-hover table-striped">
							...
							<td style="text-align: center;" colspan="6"> No members yet </td>
							<?php endif; ?>
  ...
  <div class="modal-dialog" style="" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Executive body</h5>
      ...
      <div class="modal-body">
        <form id="addmember" method="post">
		 ...
		 <input type="hidden" name="committee_id" value="<?php echo e($committee->id); ?>">
		  ...
		  <div class="form-group">
            <label for="title-name" class="col-form-label">Linkedin url:</label>
...
<div class="modal fade" id="edit<?php echo e($member->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit Executive body</h5>

      </div>
      <div class="modal-body">
        <form enctype="multipart/form-data" action="<?php echo e(route('admin.executivebody.update')); ?>" method="post">
			<?php echo e(csrf_field()); ?>
		 ...
		 <input type="hidden" name="id" value="<?php echo e($member->id); ?>">
          ...
          <div class="form-group">
		   ...
		   <div class="form-group">
		   <label>Image:</label>
		   <input type="file" name="image" id="input-file-now" data-height="150" class="dropify" data-default-file="<?php if($member->image == null): ?><?php echo e(asset('assets/img/no-image.png')); ?><?php else: ?><?php echo e(asset('assets/img/executivebody/')); ?>/<?php echo e($member->image); ?><?php endif; ?>">
           </div>
		  <div class="form-group">
            <label for="title-name" class="col-form-label">Content:</label>
		  ...
		  <div class="form-group">
            <label for="title-name" class="col-form-label">Linkedin url:</label>
            <input type="text" class="form-control" value="<?php echo e($member->linkedin_url); ?>" name="linkedin_url">
          </div>
...
$("a#remove").click(function(){
    ...
    var memberid = $(this).attr("memberid");
 	$.msgbox("Are you sure that you want to permanently delete this member?", {
	   ...
	   $.post("<?php echo e(route('admin.executivebody.remove')); ?>",
       {
         id: memberid,
...
$('#addmember').on('submit',function(event){
       ...
       $.ajax({
        url: "<?php echo e(route('admin.executivebody.add')); ?>",
        type: "post",
