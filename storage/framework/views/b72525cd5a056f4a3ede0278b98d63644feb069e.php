	...
	<div class="modal fade" id="add_notice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelgrad" aria-hidden="true">
                               <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
										...
										<form method="post" enctype="multipart/form-data" action="<?php echo e(route('acad.notice.add')); ?>">
	...
	<div class="modal fade" id="edit_notice<?php echo e($notice->id); ?>" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                               <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
										...
										<form method="post" enctype="multipart/form-data" action="<?php echo e(route('acad.notice.edit')); ?>">
										<?php echo e(csrf_field()); ?>
    ...
    buttons: {
        tryAgain: {
            ...
            action: function(){
				...
				var form = $('<form action="<?php echo e(route("acad.notice.remove")); ?>" method="post">' +
