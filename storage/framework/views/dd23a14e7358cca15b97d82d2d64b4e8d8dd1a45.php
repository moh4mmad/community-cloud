...
<?php $__env->startSection('og_image'); ?><?php echo e(asset('assets/img/members/')); ?>/<?php echo e($member->image); ?><?php $__env->stopSection(); ?>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="lecturers-contact-info">
                            <img src="<?php echo e(asset('assets/img/members/')); ?>/<?php echo e($member->image); ?>" class="img-responsive" alt="team">
...
$("#preloader").show();
       ...
       $.ajax({
        url: "<?php echo e(route('facultymembers.contact', $member->id)); ?>",
        type: "post",
