<?php $__env->startSection('title'); ?> Acad Reset Password | <?php echo e($system->app_title); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="form-items">
						...
						<hr>
                        <form method="post" action="<?php echo e(route('acad.forget.reset.post', $code)); ?>">
						...
						<div class="page-links">
                            <a href="<?php echo e(route('login.acad')); ?>">Back to Login</a>
                        </div>
...
<?php echo $__env->make('acad.auth.app.auth', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>