...
<?php $__env->startSection('content'); ?>
	...
	<div class="card">
		...
		<div class="row">
				...
				<div class="col-md-3 text-center">
					<img class="rounded img-thumbnail" width="200" height="200" alt="Image Preview" src="<?php if($student->image == null): ?> <?php echo e(asset('assets/image/students/noimg.png')); ?> <?php else: ?> <?php echo e(asset('assets/image/students')); ?>/<?php echo e($student->image); ?> <?php endif; ?>" />
				</div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="center"><strong><?php echo e($student->country); ?></strong></td>
        </tr>
		<tr>
            
            <td align="center"><strong>City</strong></td>
            <td align="center"><strong><?php echo e($student->city); ?></strong></td>
        </tr>
		<tr>
            
            <td align="center"><strong>State</strong></td>
            <td align="center"><strong><?php echo e($student->state); ?></strong></td>
        </tr>
		<tr>
		...
		<tr>
            ...
            <td align="center"><strong><?php echo e($student->Guardian->email); ?></strong></td>
				...
				<address>
				 ...
				 <strong>Address:</strong><br /> <?php echo e($student->address); ?><br /> <?php echo e($student->city); ?>, <?php echo e($student->state); ?> <?php echo e($student->postcode); ?><br /> <abbr title="Phone">Phone:</abbr> <?php echo e($student->phone); ?><br /> <abbr title="Email">Email:</abbr> <?php echo e($student->email); ?>
