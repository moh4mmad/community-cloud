                        ...
                        <li class="list-inline-item dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-right profile-dropdown">
                                ...
                                <div class="dropdown-item noti-title">
									...
									<a class="dropdown-item" href="<?php echo e(route('profile')); ?>"><i class="mdi mdi-account-circle m-r-5 text-muted"></i> Profile</a>
            ...
            <div class="container-fluid">
                <div id="navigation">
                    ...
                    <ul class="navigation-menu text-center">
                        <li class="has-submenu"><a href="<?php echo e(route('dashboard')); ?>"><i class="mdi mdi-airplay"></i>Dashboard</a></li>
                        <li class="has-submenu"><a href="<?php echo e(route('registration')); ?>"><i class="fas fa-registered"></i>Course Registration</a></li>
                        <li class="has-submenu"><a href="<?php echo e(route('history')); ?>"><i class="fas fa-history"></i>History</a></li>
						<li class="has-submenu"><a href="<?php echo e(route('profile')); ?>"><i class="fas fa-user"></i>Profile</a></li>
						<li class="has-submenu"><a href="<?php echo e(route('logout')); ?>"><i class="fas fa-sign-out-alt"></i>Sign out</a></li>
