...
<?php $__env->startSection('content'); ?>
		...
		<?php
		if($user->semester == $semester->semester)
		{
			$css = "light active";
		} else 
		{
		...
		?>
		<a href="<?php echo e(route('registrationsem', $semester->semester)); ?>" role="button" class="btn btn-<?php echo e($css); ?>"><?php echo e($semester->semester); ?></a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
						   <div class="table-responsive">
