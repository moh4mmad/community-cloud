<?php $__env->startSection('title'); ?> Accountant Reset Password | <?php echo e($system->app_title); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="form-items">
						...
						<hr>
                        <form method="post" action="<?php echo e(route('accountant.forget.reset.post', $code)); ?>">
						...
						<div class="page-links">
                            <a href="<?php echo e(route('login.accountant')); ?>">Back to Login</a>
                        </div>
