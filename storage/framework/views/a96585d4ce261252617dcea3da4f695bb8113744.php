<?php $__env->startSection('title'); ?>Sign in - <?php echo e($front->title); ?><?php $__env->stopSection(); ?>
<?php $__env->startSection('og_title'); ?>Sign in - <?php echo e($front->title); ?><?php $__env->stopSection(); ?>
<?php $__env->startSection('description'); ?><?php echo e($front->title); ?> - Sign in <?php $__env->stopSection(); ?>
<?php $__env->startSection('og_description'); ?><?php echo e($front->title); ?> - Sign in <?php $__env->stopSection(); ?>
<?php $__env->startSection('keyword'); ?>Sign in, <?php echo e($front->keywords); ?><?php $__env->stopSection(); ?>
...
<div id="wrapper">
		...
		<?php endif; ?>
                    ...
                    <form id="registration" method="post" action="<?php echo e(route('userlogin')); ?>">
					<?php echo e(csrf_field()); ?>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="login" value="<?php echo e(old('login')); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
						...
						<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<label class="check"><a href="<?php echo e(route('reset')); ?>">Lost your password?</a></label>
						</div>
						</div>
                    </form>
                </div>
