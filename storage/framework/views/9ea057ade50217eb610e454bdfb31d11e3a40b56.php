        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl">
					...
					<form role="search" method="post" action="<?php echo e(route('admin.search.deposits')); ?>">
...
<div class="modal fade" id="add_deposit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelgrad" aria-hidden="true">
                               <div class="modal-dialog" role="document">
                                    <div class="modal-content">
										...
										<form method="post" enctype="multipart/form-data" action="<?php echo e(route('admin.students.add.deposid')); ?>">
										<?php echo e(csrf_field()); ?>
    ...
    buttons: {
        formSubmit: {
            ...
            action: function () {
                ...
                var form = $('<form action="<?php echo e(route("admin.students.move.deposid")); ?>" method="post">' +
