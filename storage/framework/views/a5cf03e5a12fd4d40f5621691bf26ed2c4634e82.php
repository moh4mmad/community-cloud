...
<div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                        <ul class="profile-title">
							...
							<li class="active"><a href="<?php echo e(route('teacher.profile')); ?>">Profile</a></li>
                            <li><a href="<?php echo e(route('teacher.logout')); ?>">Sign out</a></li>
                        </ul>
                    </div>
                <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                        <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo e(route('teacher.profileup')); ?>" method="post">
		...
		<?php endif; ?>
                                    <div class="personal-info">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 public-profile-content">
                                                <input type="file" accept="image/*" name="image" id="input-file-now" data-height="150" class="dropify" data-default-file="<?php if(!$user->image == null): ?><?php echo e(asset('assets/img/members/')); ?>/<?php echo e($user->image); ?><?php endif; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="fb_url" value="<?php echo e($user->fb_url); ?>">
                                            </div>
                                        </div>
									...
									<div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="content" id="about" rows="5"><?php echo e($user->content); ?></textarea>
                                            </div>
                                        </div>
