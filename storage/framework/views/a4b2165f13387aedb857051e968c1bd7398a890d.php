...
<div id="wrapper">
		...
		<?php endif; ?>
                    ...
                    <form id="registration" method="post" action="<?php echo e(route('teacher.passwordReset', $code)); ?>">
					<?php echo e(csrf_field()); ?>
						...
						<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<label class="check"><a href="<?php echo e(route('teacher.signin')); ?>">Back to login</a></label>
						</div>
						</div>
                    </form>
                </div>
